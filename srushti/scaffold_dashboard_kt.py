...
dashboard_kt = """package com.example.adminapp
...
with open("f:/srushti/AdminApp/app/src/main/java/com/example/adminapp/DashboardActivity.kt", "w") as f:
    f.write(dashboard_kt)

print("DashboardActivity generated.")
